...
class UncorrelatedAngleEnergy(AngleEnergy):
    ...
    Parameters
    ----------
    angle : ndmanager._vendor.omc_data.AngleDistribution
        Distribution of outgoing angles represented as scattering cosines
    energy : ndmanager._vendor.omc_data.EnergyDistribution
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.UncorrelatedAngleEnergy
            Uncorrelated angle-energy distribution
