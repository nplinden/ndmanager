...
def make_pendf(filename, pendf='pendf', **kwargs):
    ...
    **kwargs
        Keyword arguments passed to :func:`ndmanager._vendor.omc_data.njoy.make_ace`. All NJOY
...
def make_ace(filename, temperatures=None, acer=True, xsdir=None,
    ...
    **kwargs
        Keyword arguments passed to :func:`ndmanager._vendor.omc_data.njoy.run`
