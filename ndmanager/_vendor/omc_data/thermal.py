...
from ndmanager._vendor.omc_data.univariate import Discrete, Tabular
...
class CoherentElastic(Function1D):
    ...
    def from_hdf5(cls, dataset):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.CoherentElastic
...
class IncoherentElastic(Function1D):
    ...
    def from_hdf5(cls, dataset):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.IncoherentElastic
...
class ThermalScatteringReaction(EqualityMixin):
    ...
    def from_hdf5(cls, group, name, temperatures):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.ThermalScatteringReaction
...
class ThermalScattering(EqualityMixin):
    ...
    elastic : ndmanager._vendor.omc_data.ThermalScatteringReaction or None
        Elastic scattering derived in the coherent or incoherent approximation
    inelastic : ndmanager._vendor.omc_data.ThermalScatteringReaction
    ...
    def add_temperature_from_ace(self, ace_or_filename, name=None) -> None:
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.ThermalScattering
    ...
    def from_njoy(
        ...
        **kwargs,
        ...
        evaluation_thermal : ndmanager._vendor.omc_data.endf.Evaluation, optional
        ...
        **kwargs
            ...
            :func:`ndmanager._vendor.omc_data.njoy.make_ace_thermal`

        Returns
        -------
        data : ndmanager._vendor.omc_data.ThermalScattering
            Thermal scattering data
    ...
    def from_endf(cls, ev_or_filename, divide_incoherent_elastic=False):
        ...
        if (7, 2) in ev.section:
            ...
            def get_incoherent_elastic(file_obj, natom):
                ...
                xs = {}
                distribution = {}
                for T, debye_waller in zip(W.x, W.y, strict=False):
