...
from .endf import SUM_RULES, Evaluation, get_evaluations, get_head_record, get_tab1_record
...
class IncidentNeutron(EqualityMixin):
    ...
    fission_energy : None or ndmanager._vendor.omc_data.FissionEnergyRelease
    ...
    resonances : ndmanager._vendor.omc_data.Resonances or None
        Resonance parameters
    resonance_covariance : ndmanager._vendor.omc_data.ResonanceCovariance or None
    ...
    def add_temperature_from_ace(self, ace_or_filename, metastable_scheme="nndc") -> None:
        ...
        Parameters
        ----------
        ace_or_filename : ndmanager._vendor.omc_data.ace.Table or str
    ...
    def add_elastic_0K_from_endf(self, filename, overwrite=False, **kwargs) -> None:
        ...
        overwrite : bool
            ...
            thrown.
        **kwargs
            Keyword arguments passed to :func:`ndmanager._vendor.omc_data.njoy.make_pendf`
    ...
    def from_hdf5(cls, group_or_filename):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.IncidentNeutron
            Continuous-energy neutron interaction data
    ...
    def from_endf(cls, ev_or_filename, covariance=False):
        ...
        Parameters
        ----------
        ev_or_filename : ndmanager._vendor.omc_data.endf.Evaluation or str
    ...
    def from_njoy(cls, filename, temperatures=None, evaluation=None, **kwargs):
        ...
        evaluation : ndmanager._vendor.omc_data.endf.Evaluation, optional
            If the ENDF file contains multiple material evaluations, this
            argument indicates which evaluation to use.
        **kwargs
            Keyword arguments passed to :func:`ndmanager._vendor.omc_data.njoy.make_ace`

        Returns
        -------
        data : ndmanager._vendor.omc_data.IncidentNeutron
            Incident neutron continuous-energy data
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            for ev, ev_local, temp in zip(heatr_evals, heatr_local_evals, data.temperatures, strict=False):
    ...
    def _get_redundant_reaction(self, mt, mts):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.Reaction
            Redundant reaction
