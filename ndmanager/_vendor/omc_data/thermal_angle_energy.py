...
class CoherentElasticAE(AngleEnergy):
    ...
    Parameters
    ----------
    coherent_xs : ndmanager._vendor.omc_data.CoherentElastic
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.CoherentElasticAE
            Coherent elastic distribution

        """
        coherent_xs = ndmanager._vendor.omc_data.CoherentElastic.from_hdf5(group['coherent_xs'])
...
class IncoherentElasticAE(AngleEnergy):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.IncoherentElasticAE
...
class IncoherentElasticAEDiscrete(AngleEnergy):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.IncoherentElasticAEDiscrete
...
class IncoherentInelasticAEDiscrete(AngleEnergy):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.IncoherentInelasticAEDiscrete
...
class MixedElasticAE(AngleEnergy):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.MixedElasticAE
