...
from ndmanager._vendor.omc_data.univariate import Univariate, Tabular, Discrete, Mixture
...
class EnergyDistribution(EqualityMixin, ABC):
    ...
    def from_hdf5(group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.EnergyDistribution
            Energy distribution
    ...
    def from_endf(file_obj, params):
        ...
        -------
        ndmanager._vendor.omc_data.EnergyDistribution
            A sub-class of :class:`ndmanager._vendor.omc_data.EnergyDistribution`
...
class ArbitraryTabulated(EnergyDistribution):
    ...
    pdf : list of ndmanager._vendor.omc_data.Tabulated1D
    ...
    def from_endf(cls, file_obj, params):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.ArbitraryTabulated
...
class GeneralEvaporation(EnergyDistribution):
    ...
    Parameters
    ----------
    theta : ndmanager._vendor.omc_data.Tabulated1D
        Tabulated function of incident neutron energy :math:`E`
    g : ndmanager._vendor.omc_data.Tabulated1D
    ...
    def from_endf(cls, file_obj, params):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.GeneralEvaporation
...
class MaxwellEnergy(EnergyDistribution):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.MaxwellEnergy
...
class Evaporation(EnergyDistribution):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.Evaporation
...
class WattEnergy(EnergyDistribution):
    ...
    Parameters
    ----------
    a, b : ndmanager._vendor.omc_data.Tabulated1D
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.WattEnergy
...
class MadlandNix(EnergyDistribution):
    ...
    tm : ndmanager._vendor.omc_data.Tabulated1D
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.MadlandNix
...
class DiscretePhoton(EnergyDistribution):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.DiscretePhoton
            Discrete photon energy distribution
...
class LevelInelastic(EnergyDistribution):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.LevelInelastic
...
class ContinuousTabular(EnergyDistribution):
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.ContinuousTabular
