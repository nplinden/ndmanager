...
from ndmanager._vendor.omc_data.checkvalue import check_type, check_greater_than, PathLike
...
def replace_missing(product, decay_data):
    ...
    Z, A, state = ndmanager._vendor.omc_data.zam(product)
    symbol = ndmanager._vendor.omc_data.ATOMIC_SYMBOL[Z]
    ...
    while product not in decay_data:
        if Z > 98:
            ...
            if beta_minus:
                ...
                Z -= 1
        product = f'{ndmanager._vendor.omc_data.ATOMIC_SYMBOL[Z]}{A}'
...
class Chain:
    ...
    Attributes
    ----------
    nuclides : list of ndmanager._vendor.omc_data.Nuclide
    ...
    stable_nuclides : list of ndmanager._vendor.omc_data.Nuclide
        List of stable nuclides available in the chain.
    unstable_nuclides : list of ndmanager._vendor.omc_data.Nuclide
    ...
    def add_nuclide(self, nuclide: Nuclide):
        ...
        Parameters
        ----------
        nuclide : ndmanager._vendor.omc_data.Nuclide
            Nuclide to add
    ...
    def from_endf(cls, decay_files, fpy_files, neutron_files,
        ...
        Alternatively, :class:`ndmanager._vendor.omc_data.endf.Evaluation` instances
        can be included in these arguments.

        Parameters
        ----------
        decay_files : list of str or ndmanager._vendor.omc_data.endf.Evaluation
            List of ENDF decay sub-library files
        fpy_files : list of str or ndmanager._vendor.omc_data.endf.Evaluation
            List of ENDF neutron-induced fission product yield sub-library files
        neutron_files : list of str or ndmanager._vendor.omc_data.endf.Evaluation
        ...
        reactions : iterable of str, optional
            ...
            found in :data:`ndmanager._vendor.omc_data.chain.REACTIONS`.
        ...
        for f in neutron_files:
            ...
            for mf, mt, nc, mod in evaluation.reaction_list:
                if mf == 3:
                    ...
                    q_value = ndmanager._vendor.omc_data.endf.get_cont_record(file_obj)[1]
        ...
        for idx, parent in enumerate(sorted(decay_data, key=ndmanager._vendor.omc_data.zam)):
            ...
            if parent in reactions:
                ...
                for name in transmutation_reactions:
                    ...
                    delta_A, delta_Z = ndmanager._vendor.omc_data.DADZ[name]
                    if mts & reactions_available:
                        A = data.nuclide['mass_number'] + delta_A
                        Z = data.nuclide['atomic_number'] + delta_Z
                        daughter = f'{ndmanager._vendor.omc_data.ATOMIC_SYMBOL[Z]}{A}'
                ...
                if any(mt in reactions_available for mt in ndmanager._vendor.omc_data.FISSION_MTS):
