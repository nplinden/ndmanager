...
class Product(EqualityMixin):
    ...
    Attributes
    ----------
    applicability : Iterable of ndmanager._vendor.omc_data.Tabulated1D
        Probability of sampling a given distribution for this product.
    decay_rate : float
        Decay rate in inverse seconds
    distribution : Iterable of ndmanager._vendor.omc_data.AngleEnergy
    ...
    yield_ : ndmanager._vendor.omc_data.Function1D
        Yield of secondary particle in the reaction.

    """

    def __init__(self, particle="neutron") -> None:
        self.applicability = []
        self.decay_rate = 0.0
        self.distribution = []
    ...
    @decay_rate.setter
    def decay_rate(self, decay_rate) -> None:
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.Product
            Reaction product
