...
from ndmanager._vendor.omc_data.univariate import Legendre, Tabular, Uniform
...
from .energy_distribution import DiscretePhoton, EnergyDistribution, LevelInelastic
...
def _get_products(ev, mt):
    ...
    Returns
    -------
    products : list of ndmanager._vendor.omc_data.Product
...
def _get_fission_products_ace(ace):
    ...
    derived_products : list of ndmanager._vendor.omc_data.Product
...
def _get_activation_products(ev, rx):
    ...
    ev : ndmanager._vendor.omc_data.endf.Evaluation
        The ENDF evaluation
    rx : ndmanager._vendor.omc_data.Reaction
...
def _get_photon_products_ace(ace, rx):
    ...
    Returns
    -------
    photons : list of ndmanager._vendor.omc_data.Products
...
def _get_photon_products_endf(ev, rx):
    ...
    Returns
    -------
    products : list of ndmanager._vendor.omc_data.Products
        Photons produced from reaction with given MT
...
class Reaction(EqualityMixin):
    ...
    xs : dict of str to ndmanager._vendor.omc_data.Function1D
    ...
    products : Iterable of ndmanager._vendor.omc_data.Product
        Reaction products
    derived_products : Iterable of ndmanager._vendor.omc_data.Product
