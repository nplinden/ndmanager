...
from ndmanager._vendor.omc_data.chain import Chain
from ndmanager._vendor.omc_data.exceptions import DataError
from ndmanager._vendor.omc_data.mixin import EqualityMixin
from ndmanager._vendor.omc_data.univariate import Discrete, Tabular, Univariate, combine_distributions
...
class FissionProductYields(EqualityMixin):
    ...
    Parameters
    ----------
    ev_or_filename : str of ndmanager._vendor.omc_data.endf.Evaluation
    ...
    def from_endf(cls, ev_or_filename):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.FissionProductYields
...
class Decay(EqualityMixin):
    ...
    sources : dict
        ...
        :class:`ndmanager._vendor.omc_data.stats.Univariate`.
            ...
            for i in range(NSP):
                ...
                if spectrum["continuous_flag"] != "discrete":
                    ...
                    if LCOV != 0:
                        ...
                        ci["covariance"] = zip(values[0::2], values[1::2], strict=False)
    ...
    def from_endf(cls, ev_or_filename):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.Decay
            Radioactive decay data
...
def decay_photon_energy(nuclide: str, chain_file: cv.PathLike = None) -> Univariate | None:
    ...
    chain_file : cv.PathLike, optional
        Path to the depletion chain file.

    Returns
    -------
    ndmanager._vendor.omc_data.stats.Univariate or None
