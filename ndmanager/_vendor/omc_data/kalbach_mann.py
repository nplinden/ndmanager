...
class KalbachMann(AngleEnergy):
    ...
    precompound : Iterable of ndmanager._vendor.omc_data.Tabulated1D
        Precompound factor 'r' as a function of outgoing energy for each
        incoming energy
    slope : Iterable of ndmanager._vendor.omc_data.Tabulated1D
    ...
    def from_hdf5(cls, group):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.KalbachMann
