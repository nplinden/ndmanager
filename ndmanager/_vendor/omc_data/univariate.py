...
from ndmanager._vendor.omc_data._xml import get_text
...
class Discrete(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Discrete
    ...
    def merge(
        ...
        Parameters
        ----------
        dists : iterable of ndmanager._vendor.omc_data.stats.Discrete
...
class Uniform(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Uniform
...
class PowerLaw(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.PowerLaw
...
class Maxwell(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Maxwell
...
class Watt(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Watt
...
class Normal(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Normal
...
class Tabular(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Tabular
...
class Mixture(Univariate):
    ...
    def from_xml_element(cls, elem: ET.Element):
        ...
        Returns
        -------
        ndmanager._vendor.omc_data.stats.Mixture
...
def combine_distributions(
    ...
    remainder of the distributions are put into a :class:`~ndmanager._vendor.omc_data.stats.Mixture`
    distribution.
    ...
    Parameters
    ----------
    dists : iterable of ndmanager._vendor.omc_data.stats.Univariate
